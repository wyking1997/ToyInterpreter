...
public class Interpreter {
    public static void main(String[] args) {
        ...
        PrgState state3 = new PrgState(new ExecutionStack<IStm>(), new ExecutionDictionary<String, Integer>(), new ExecutionOut<Integer>(), new ExecutionFileTable<Integer, Pair<String, BufferedReader>>(), new ExecutionHeap<Integer>(),stm4);
        ...
        PrgState state4 = new PrgState(new ExecutionStack<IStm>(), new ExecutionDictionary<String, Integer>(), new ExecutionOut<Integer>(), new ExecutionFileTable<Integer, Pair<String, BufferedReader>>(), new ExecutionHeap<Integer>(),stm6);
